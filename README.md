...
│   ├── im_diagram.py           # Mermaid classDiagram generator
...
make dist            # regenerate every artefact in dist/ (CSVs + merged OWL)
...
Four layers of validation, all runnable via `make test` or
...
4. **OWL reasoner (`TestOwlreadyConsistency`, optional)** — converts
